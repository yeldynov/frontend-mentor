  ...
  return (
    <div className="text-huddle-dark-cyan min-w-[375px] font-sans text-lg lg:max-w-[1440px]">
      <header className="bg-opacity-50 bg-[url('/huddle-lp-alternate/bg-hero-desktop.svg')] bg-cover pb-20">
        <div className="flex flex-col px-5 pt-7 md:px-20 md:pt-12">
          ...
          <div className="flex w-full items-center justify-between">
            <img
              className="w-[117px] fill-green-200 md:w-[200px]"
      ...
      <main className="mx-5 mt-5 flex flex-col items-center justify-center gap-10 md:mx-[105px] md:mt-36">
        ...
        <section className="flex flex-col items-center justify-between gap-12 rounded-2xl bg-white px-9 py-[56px] pb-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] md:flex-row md:gap-0 md:p-10 md:py-10">
          <div className="mt-2 w-[85%] md:ml-10 md:mt-0 md:w-4/5 md:py-3">
            <img
              className="md:ml-3"
      ...
      <footer className="relative mt-[370px] flex flex-col items-center justify-between bg-[#00242e] p-8 px-5 pb-24 pt-48 text-white md:px-[120px]">
        {/* absolute */}
        <div className="absolute -top-[185px] flex flex-col items-center justify-center gap-11 rounded-2xl bg-white text-center shadow-[0_8px_30px_rgb(0,0,0,0.12)] md:h-[283px] md:w-[800px]">
          <h2 className="text-huddle-dark-cyan mt-5 font-poppins text-[32px] font-semibold">
            Ready To Build Your Community?
          </h2>
          <button className="bg-huddle-pink rounded-full px-[105px] py-[25px] text-xl font-semibold text-white">
            Get Started For Free
          </button>
        </div>
        {/* cols */}
        <div className="flex w-full flex-col items-center justify-between text-sm md:flex-row">
          {/* contacts */}
          <div className="mb-6 text-center md:mb-0 md:text-left">
            ...
            <div className="flex max-w-sm flex-col gap-6">
              <div className="flex items-start justify-start gap-7">
                <img
                  className="mt-2"
                  src="/huddle-lp-alternate/icon-location.svg"
                  alt="Location"
                />
              ...
              <div className="flex items-start justify-start gap-5">
                <img
                  className="mt-1"
                  src="/huddle-lp-alternate/icon-phone.svg"
                  alt="Location"
                />
                <p className="text-base">+1-543-123-4567</p>
              </div>
              <div className="flex items-start justify-start gap-5">
                <img
                  className="mt-1"
                  src="/huddle-lp-alternate/icon-email.svg"
                  alt="Location"
                />
                <p className="text-base">example@huddle.com</p>
              </div>
            </div>
          </div>
          {/* links */}
          <div className="mt-5 flex flex-col self-start text-2xl md:flex-row md:gap-[120px] md:self-center md:pr-[120px] md:text-lg">
            <div className="flex flex-col gap-4">
              <a href="https://github.com/">About Us</a>
              <a href="https://github.com/">What We Do</a>
              <a href="https://github.com/">FAQ</a>
            </div>
            <div className="flex flex-col gap-4">
              <a href="https://github.com/">Career</a>
              <a href="https://github.com/">Blog</a>
              <a href="https://github.com/">Contact Us</a>
            </div>
            <div className="flex flex-col">
              <div className="mt-20 flex gap-6 pt-1 md:mt-0 md:pl-8">
                <FaFacebookF />
                <FaTwitter />
                <FaInstagram />
              </div>
        ...
        <div className="mt-10 text-center text-xs md:-mr-8 md:self-end md:text-left">
